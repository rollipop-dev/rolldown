...
define_hooks! {
  ...
  // MARK - rollipop
  transform_cache_hit: TransformCacheHitFn {
    usage: TransformCacheHit,
    call: call_transform_cache_hit,
    call_meta: call_transform_cache_hit_meta,
    meta: transform_cache_hit_meta,
    default: default_transform_cache_hit,
    args: (ctx: &'a PluginContext, id: &'a str),
    output: HookNoopReturn,
  }
}
