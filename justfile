...
build-rolldown-release: build-pluginutils
  vp run --filter '@rollipop/rolldown' build-native:release

# Build `rolldown` located in `packages/rolldown` itself and its `.node` binding in profile mode.
build-rolldown-profile:
  vp run --filter '@rollipop/rolldown' build-native:profile

build-rolldown-memory-profile:
  vp run --filter '@rollipop/rolldown' build-native:memory-profile
...
# Build `@rollipop/rolldown-pluginutils` located in `packages/pluginutils`.
build-pluginutils:
  vp run --filter "@rollipop/rolldown-pluginutils" build
