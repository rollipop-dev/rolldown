...
export function bindingifyOutputOptions(
  ...
  if (
    outputOptions.minify != null &&
    typeof outputOptions.minify === 'object' &&
    outputOptions.minify.mangleProps != null
  ) {
    throw new Error(
      'The option "output.minify.mangleProps" requires an OXC version newer than the one used by @rollipop/rolldown.',
    );
  }
